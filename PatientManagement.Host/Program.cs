...
using PatientManagement.Api;
using PatientManagement.Data.MongoDb.Repositories;
using PatientManagement.Data.Repositories;
...
#pragma warning restore CS0618
  ...
  builder.Services.AddControllers()
                  .ConfigureApplicationPartManager(apm => apm.ApplicationParts.Add(new AssemblyPart(typeof(PatientController).Assembly)))
                  ;
