...
using ObservationManagement.Api;
using ObservationManagement.Data.MongoDb.Repositories;
using ObservationManagement.Data.Repositories;
...
#pragma warning restore CS0618
  ...
  builder.Services.AddControllers()
                  .ConfigureApplicationPartManager(apm => apm.ApplicationParts.Add(new AssemblyPart(typeof(ObservationController).Assembly)))
                  ;
